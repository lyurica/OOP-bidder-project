...
class Bidder:
    """Class that contains the number of User objects in the game
    and the total number of rounds to be played"""
    bid_num = 0
    ...
    def bid(self, user_id):
        ...
        regularly updated as information on user click rate is gained.
        Testing suggests this should defeat most models with the exception
        being a 1 vs 1 against a Bidding model using its expected value
        of click rates.
        """
